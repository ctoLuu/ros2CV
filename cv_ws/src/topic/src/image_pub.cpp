...
public:
    imagePub() : Node("image_pub")
    {
        ...
        subscriber_ = this->create_subscription<topic_interfaces::msg::Coord>("coord", 10, std::bind(&imagePub::coord_callback, this, std::placeholders::_1));
        cap.open(0, CAP_V4L2);
...
private:
    ...
    rclcpp::Subscription<topic_interfaces::msg::Coord>::SharedPtr subscriber_;
    ...
    void coord_callback(const topic_interfaces::msg::Coord::SharedPtr msg)
    {
        int x = msg->x;
        int y = msg->y;
