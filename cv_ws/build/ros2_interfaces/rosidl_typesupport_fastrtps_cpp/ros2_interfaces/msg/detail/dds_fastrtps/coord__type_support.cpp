...
#include "ros2_interfaces/msg/detail/coord__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interfaces::msg::Coord & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interfaces::msg::Coord & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interfaces::msg::Coord;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interfaces::msg::Coord *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interfaces::msg::Coord *>(
    untyped_ros_message);
...
{
  return &ros2_interfaces::msg::typesupport_fastrtps_cpp::_Coord__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interfaces, msg, Coord)() {
  return &ros2_interfaces::msg::typesupport_fastrtps_cpp::_Coord__handle;
}
