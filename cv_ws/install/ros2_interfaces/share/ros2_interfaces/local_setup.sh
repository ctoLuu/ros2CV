...
: ${AMENT_CURRENT_PREFIX:="/home/stoair/ros2CV/cv_ws/install/ros2_interfaces"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros2_interfaces/environment/library_path.sh"
