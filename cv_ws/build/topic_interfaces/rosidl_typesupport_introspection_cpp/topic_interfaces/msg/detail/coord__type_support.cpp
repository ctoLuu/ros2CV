...
{
  new (message_memory) topic_interfaces::msg::Coord(_init);
}

void Coord_fini_function(void * message_memory)
{
  auto typed_message = static_cast<topic_interfaces::msg::Coord *>(message_memory);
  typed_message->~Coord();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Coord_message_member_array[3] = {
  {
    ...
    offsetof(topic_interfaces::msg::Coord, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(topic_interfaces::msg::Coord, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(topic_interfaces::msg::Coord, flag_servo),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Coord_message_members = {
  "topic_interfaces::msg",  // message namespace
  "Coord",  // message name
  3,  // number of fields
  sizeof(topic_interfaces::msg::Coord),
...
get_message_type_support_handle<topic_interfaces::msg::Coord>()
{
  return &::topic_interfaces::msg::rosidl_typesupport_introspection_cpp::Coord_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, topic_interfaces, msg, Coord)() {
  return &::topic_interfaces::msg::rosidl_typesupport_introspection_cpp::Coord_message_type_support_handle;
}
