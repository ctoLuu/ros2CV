...
static const _Coord_type_support_symbol_names_t _Coord_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, topic_interfaces, msg, Coord)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, topic_interfaces, msg, Coord)),
  }
};
...
{
  return &::topic_interfaces::msg::rosidl_typesupport_cpp::Coord_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, topic_interfaces, msg, Coord)() {
  return get_message_type_support_handle<topic_interfaces::msg::Coord>();
}
