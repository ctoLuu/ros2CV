...
static const _Coord_type_support_symbol_names_t _Coord_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, topic_interfaces, msg, Coord)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, topic_interfaces, msg, Coord)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, topic_interfaces, msg, Coord)() {
  return &::topic_interfaces::msg::rosidl_typesupport_c::Coord_message_type_support_handle;
}
