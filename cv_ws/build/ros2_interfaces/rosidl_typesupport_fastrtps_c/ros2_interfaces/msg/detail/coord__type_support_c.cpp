...
#include "ros2_interfaces/msg/detail/coord__rosidl_typesupport_fastrtps_c.h"
...
using _Coord__ros_msg_type = ros2_interfaces__msg__Coord;
...
size_t get_serialized_size_ros2_interfaces__msg__Coord(
  const void * untyped_ros_message,
...
static uint32_t _Coord__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interfaces__msg__Coord(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interfaces
size_t max_serialized_size_ros2_interfaces__msg__Coord(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interfaces__msg__Coord;
    is_plain =
      (
...
static size_t _Coord__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interfaces__msg__Coord(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interfaces, msg, Coord)() {
