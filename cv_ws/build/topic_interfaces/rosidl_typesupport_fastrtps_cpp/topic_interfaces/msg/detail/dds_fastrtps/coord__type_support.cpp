...
#include "topic_interfaces/msg/detail/coord__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_topic_interfaces
cdr_serialize(
  const topic_interfaces::msg::Coord & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  topic_interfaces::msg::Coord & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = topic_interfaces::msg::Coord;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const topic_interfaces::msg::Coord *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<topic_interfaces::msg::Coord *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_topic_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<topic_interfaces::msg::Coord>()
{
  return &topic_interfaces::msg::typesupport_fastrtps_cpp::_Coord__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, topic_interfaces, msg, Coord)() {
  return &topic_interfaces::msg::typesupport_fastrtps_cpp::_Coord__handle;
}
